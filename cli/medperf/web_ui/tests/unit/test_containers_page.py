...
def test_empty_containers_ui_page_content(page, mocker):
    ...
    assert page.get_attribute(page.MINE_SWITCH, "data-entity-name") == "containers"
...
def test_containers_ui_page_content(page, mocker):
    ...
    for container in containers_cards:
        ...
        cont_valid_txt = container.find_element(*page.CARD_VALID).text
        ...
        assert cont_valid == str(TEST_CONTAINERS[cont_id].is_valid)
